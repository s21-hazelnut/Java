...
public class OrmManager {
        ...
        private void createTable(Class<?> entityClass) throws SQLException {
            ...
            String sqlCreateTable = "CREATE TABLE IF NOT EXISTS " + tableName + "(id SERIAL PRIMARY KEY NOT NULL, " +
        ...
        public void save(Object entityObj) {
            List<Object> fieldList = getAnnotatedFieldValues(entityObj);
            ...
            String foArgs = new String(new char[columns.size() - 1]).replace("\0", "?, ");
        ...
        public void update(Object entityObj) {
            ...
            String sqlUpdate = "UPDATE " + tableName + " SET " + String.join(" = ?, ", columns) + "= ? " +
                    "WHERE id = " + id + ";";
        ...
        private void setSql(String sql, List<Object> fieldList) {
            try (PreparedStatement statement = connection.prepareStatement(sql)) {
                for (int j = 1; j < fieldList.size(); j++) {
                    Object value = fieldList.get(j);
                    if (value instanceof Integer) {
                        ...
                        throw new IllegalArgumentException("   !!!ACHTUNG!!!   Unsupported value type: " + value.getClass());
                    }
                }
       ...
       private void printSql(String message) {
        ...
        private String getColumnType(Class<?> fieldType, int length) {
            if (fieldType == String.class) {
                ...
                throw new IllegalArgumentException("   !!!ACHTUNG!!!   Unsupported field type: " + fieldType.toString());
            }
        }
